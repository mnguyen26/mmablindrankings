    ...
    return (
        <div>
            ...
            <div className='paragraph-text'>
                <p>In this game, you'll explore decision-making with limited information.</p>
                <p>Screen 1: You'll receive ten random fighters to rank based on their career peaks (not current ability).</p>
                <p>Screen 2: You'll also rank ten fighters but you'll see them one by one, ranking each as they appear. You won't know who's coming next, and you can't adjust previous rankings.</p>
